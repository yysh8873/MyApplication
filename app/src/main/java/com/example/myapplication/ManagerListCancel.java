...
public class ManagerListCancel extends AppCompatActivity {

    String serverURL = "http://13.125.45.205/orderlistall2.php";
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(ManagerListCancel.this,
    ...
    private void showResult(){
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(
                    ManagerListCancel.this, mArrayList, R.layout.item_list2,
